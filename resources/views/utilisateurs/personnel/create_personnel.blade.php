...
<div class="container">
    ...
    <div class="form">
        <h3 style="margin:10px 35px;color:var(--primary)">Ajouter un personnel</h3>
        <form action="{{ url('insert_personnel') }}" method="POST">
      @csrf
            <div class="col">
                 <div class="row">
                  <div class="input_row">
            ...
            <div class="input_row">
                ...
                <div class="input_group">
                    ...
                    <div class="input">
                        <input type="text" name="prenom" placeholder="Nom et Prenom">
                    </div>
                </div>
            </div>
            <div class="input_row">
                ...
                <div class="input_group">
                    ...
                    <div class="input">
                        <input type="number" name="telephone" placeholder="+257 76 78 76">
                    </div>
                </div>
            </div>
            <div class="input_row">
        ...
        <div class="row">
            <div class="input_row">
                ...
                <div class="input_group">
                    ...
                    <div class="input">
                        <input type="email" name="mail" placeholder="exemple@biu.bi" required>
                    </div>
                </div>
            </div>
            <div class="input_row">
